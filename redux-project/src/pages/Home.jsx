...
import shopItemsData from "../utils";

const Home = () => {
  const [products, setProducts] = useState(shopItemsData); //writing array in useState means data will be comming in the form of array
